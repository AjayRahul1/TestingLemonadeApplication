...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        var imageLemon: ImageView = findViewById(R.id.image_lemon_state)
        ...
        when (lemonadeState) {
            SELECT -> {textAction.text = resources.getString(R.string.lemon_select)
                imageLemon.setImageResource(R.drawable.lemon_tree)
            }
            SQUEEZE -> {
                textAction.text = resources.getString(R.string.lemon_squeeze)
                imageLemon.setImageResource(R.drawable.lemon_squeeze)
            }
            DRINK -> {
                textAction.text = resources.getString(R.string.lemon_drink)
                imageLemon.setImageResource(R.drawable.lemon_drink)
            }
            RESTART -> {
                textAction.text = resources.getString(R.string.lemon_empty_glass)
                imageLemon.setImageResource(R.drawable.lemon_restart)
            }
        }
